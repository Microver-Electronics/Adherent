...
val('dist','<b>24 V + derived 12 V · separate fused rails / common 0 V</b><br>24 V: F1–F10 lane motors · F11 chuck · F15/F16 gantry (TBC) · F17 DOORIO<br>Derived 12 V: F12 SYSCTRL · F13 MAINCTRL · F14 lane logic · F18 latch contacts<br>Fuse ratings and cable sizes require review for the single-PSU architecture')
...
val('doorio','<b>DOORIO · Waveshare ESP32-S3-ETH-8DI-8RO · COTS ×1</b><br><b>Module power: 24 V via F17 / W34</b> · rated input 7–36 V<br>MAINCTRL ↔ isolated RS485 · planned Modbus RTU firmware<br><b>Relay COM supply: separate derived 12 V via F18 / W35</b><br>RO1–4: latches · DI1–5: door sensors · RO5–8: reserved · Wi-Fi / BLE / Ethernet unused')
geo('doorio',height=120);sty('doorio',fillColor='#EEF3F9',strokeColor='#1D5FA8',fontSize=12)
...
val('e_12doorio','W34 · F17 · 24 V module');sty('e_12doorio',entryY=.525)
new=copy.deepcopy(c['e_12doorio']);new.set('id','e_contact12');root.append(new);c['e_contact12']=new
...
val('tables_ref','<b>R25 diagram update:</b> one 24 V PSU; DOORIO powered at 24 V; separate 12 V relay-contact feed. <b>R23 Excel is historical:</b> PSU, fuse, cable and power entries are not yet aligned. W35 / F18 are provisional new references; W02 / W31 / W32 retired.')
