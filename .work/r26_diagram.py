...
val('dist','<b>DIN distribution · 24 V rail + separate SYSCTRL-derived 12 V rail</b><br>24 V: F1–F10 lanes · F11 SYSCTRL motors · F12 SYSCTRL buck · F15/F16 gantry (TBC) · F17 DOORIO<br>12 V from SYSCTRL W04: F13 MAINCTRL · F18 latch contacts<br>F14 lane-logic protection is on SYSCTRL. All ratings / wire sizes require review.')
...
val('doorio',c['doorio'].get('value').replace('separate derived 12 V via F18 / W35','SYSCTRL-derived 12 V via F18 / W35'))
